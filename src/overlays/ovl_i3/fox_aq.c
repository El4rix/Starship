...
void Aquas_801A99D4(Player* player) {
    ...
    if ((D_i3_801C4190[8] < sp24) && (D_i3_801C41B8[25] < 4600.0f)) {
        ...
        if ((gPlayer[0].form != FORM_ON_FOOT) || (gBossActive)) {
            ...
            D_i3_801C41B8[12] -= 2.0f;
            if (D_i3_801C41B8[12] < 10.0f) {
                D_i3_801C41B8[12] = 10.0f;
            }

            D_i3_801C41B8[13] -= 6.0f;
            if (D_i3_801C41B8[13] < 30.0f) {
                D_i3_801C41B8[13] = 30.0f;
            }

            D_i3_801C41B8[14] -= 6.0f;
            if (D_i3_801C41B8[14] < 50.0f) {
                D_i3_801C41B8[14] = 50.0f;
            }
            ...
            D_i3_801C41B8[16] -= 1.5f;
            if (D_i3_801C41B8[16] < 3.0f) {
                D_i3_801C41B8[16] = 3.0f;
            }

            D_i3_801C41B8[17] -= 2.5f;
            if (D_i3_801C41B8[17] < 5.0f) {
                D_i3_801C41B8[17] = 5.0f;
            }
        }
